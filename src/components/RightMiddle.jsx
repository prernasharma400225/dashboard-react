...
const RightMiddle = () => {
  return (
    <div className='relative h-80 w-full'>
              <img className='absolute w-full h-full  rounded-2xl   object-cover' src="https://trendwalls.com.ua/image/cache/catalog/products/Dly%20malchikov/6303-1920x1280.jpg" alt="" />
